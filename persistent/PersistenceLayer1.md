...
# 1.导入bboss
先在应用中导入bboss 持久层：bboss persistent最新版本号6.3.5，以实际为准，查看[最新版本号](https://repo1.maven.org/maven2/com/bbossgroups/bboss-persistent/)
...
```java
compile 'com.bbossgroups:bboss-persistent:6.3.5'  
```
